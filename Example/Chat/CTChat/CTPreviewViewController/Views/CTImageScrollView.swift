...
internal final class CTImageScrollView: UIScrollView {
    ...
    private func configurateFor(imageSize: CGSize) {
        ...
        self.setupForCurrentDeviceOrientation()
...
extension CTImageScrollView: UIScrollViewDelegate {
